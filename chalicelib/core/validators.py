...
MAX_COMMENT_LENGTH = os.environ["MAX_COMMENT_LENGTH"]
MIN_SCAN_DURATION_IN_SECONDS = 3600 * os.environ["MIN_SCAN_DURATION_IN_SECONDS"]
SCAN_SCHEDULABLE_DAYS_FROM_NOW = os.environ["SCAN_SCHEDULABLE_DAYS_FROM_NOW"]
SCAN_SCHEDULABLE_DAYS_FROM_START_DATE = os.environ["SCAN_SCHEDULABLE_DAYS_FROM_START_DATE"]
